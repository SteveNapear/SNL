...
namespace SNL {
	...
	public class CGeo {   //A geo point
		...
		//====================================================================
		public double GCArcAngleRads(CGeo geo) {   //returns angle in radians of great circle arc
		...
		//.....................................................................
		public static double operator *(CGeo lhs, CGeo rhs) {       //dot product
		...
		//.............................................................................
		public static CGeo Point2CGeo(Rect R, System.Windows.Point pt) {
			double dx = 0.5 - (pt.X - R.Left) / R.Width;
			double lon = -360.0 * dx;
			double dy = 0.5 - (pt.Y - R.Top) / R.Height;
			double lat = 180.0 * dy;
			return new CGeo(lat, lon);
		}
		...
		//....................................................................
		public static double WGS84km(CGeo fr, CGeo to) {   //Vincenty's formulae 
		...
		public static CGeo PTBD2Geo(CGeo fr, double distkm, double beartruedeg) {
			...
			while (Math.Abs(sigma - sigmaP) > 1e-12) {//while (Math.abs(sigma-sigmaP) > 1e-12) {    
	...
	//////////////////////////////////////////////////////////////////////
	[Serializable]
	public class CWayPoint : CGeo {   //A CGeo with a name and a flood tide heading (true)
		...
		//=================================================================
		public double HeadingTo(CWayPoint wp) {       //returns angle, in Radians, from true north, to wp.
